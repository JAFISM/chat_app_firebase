  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(
        top: 4,bottom: 4,left: widget.sendByMe?0:24,right: widget.sendByMe?24:0,
      ),
      alignment: widget.sendByMe?Alignment.centerRight:Alignment.centerLeft,
      child: Container(
        margin: widget.sendByMe? const EdgeInsets.only(left: 30)
        ...
        decoration: BoxDecoration(
          ...
          color: widget.sendByMe?Theme.of(context).primaryColor:Constants.c2
        ),
        child: Column(
